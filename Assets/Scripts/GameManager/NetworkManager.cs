...
public class NetworkManager : MonoBehaviour {
	...
	public static Vector3 spawnspot69;
	[SerializeField] public ServerSettings advancedSettings;
	
	[System.Serializable]
	public class ServerSettings
	{
		public string gameName = "Territories";		// When RefreshHostList() is called, only servers with this exact string will be displayed CTRL-F GNINFO FOR IMPORTANT INFO
	...
	[SerializeField] GameObject lobbycreate;

	private GameObject thislobby;
...
void Start(){
		MasterServer.ipAddress = "216.167.251.202";
		MasterServer.port = 23466;
		Network.natFacilitatorIP = "216.167.251.202";
...
//		username = "Player"+Random.Range(0,99).ToString();	// We're randomizing a digit at the end, just to give some variety
	...
	public void StartServer() {
		...
		else if (advancedSettings.passwordProtected && advancedSettings.password == "")
		{
			...
			{
			thislobby = Network.Instantiate(lobbycreate, Vector3.zero, Quaternion.Euler(0, 90, 0), 0) as GameObject;
			}
				//Destroy(thislobby);
			Debug.Log ("ONLY ONCE");
		}
...
//		GameObject[] names = GameObject.FindGameObjectsWithTag("lobbies");
//		
...
//			Destroy(item);
//		}
		GameObject name = GameObject.FindGameObjectWithTag("lobbies");
		name.SetActive(false);
//
//
//		//Destroy (thislobby.gameObject);
//		Debug.Log ("KILL KILL");
	...
	public void respawn1f(){
		...
		GameObject playerObj1f = Network.Instantiate(Team1Female, new Vector3(44f, 5f, 46f), Quaternion.Euler(0, 90, 0), 0) as GameObject;
	}
	public void respawn2f(){
	...
	//	standbyCamera.SetActive(false);
		...
		//GameObject playerObjxx =   Network.Instantiate(playerspawn, new Vector3(44f, 5f, 42f), Quaternion.Euler(0, 90, 0), 1) as GameObject;
